...
const Apple=()=>
{
    return(
        ...
        <div id={STYLE.main}>
        <div>
        <img id={STYLE.image}scr="https://yt3.googleusercontent.com/dW6to0x5Crmeh7yi-YPLcQRqVrBtx2BSh8eoKTJbE8NbjloQ0sqlmdszIlxokJU_97-ndOt_=s900-c-k-c0x00ffffff-no-rj" alt=""/>
        </div>
        <div>
            <ul id={STYLE.menu}>
            <li>
